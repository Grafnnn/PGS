...
const headerAliases: Record<keyof ColumnMap, string[]> = {
  index: ["no", "n", "номер", "п п", "пп", "№", "№ п п", "номер п п", "шифр", "код", "позиция"],
  name: ["наименование", "наименование работ", "наименование работ и затрат", "название", "работы", "материалы", "позиция", "вид работ", "ресурс", "наименование затрат"],
  unit: ["ед изм", "единица", "единица измерения", "ед", "изм", "е изм", "единицы измерения"],
  qty: ["кол во", "количество", "объем", "обьем", "qty", "кол-во", "объём", "объем работ", "объём работ", "объемы"],
  unitPrice: ["цена за ед", "цена ед", "цена", "расценка", "стоимость ед", "цена единицы", "стоимость единицы", "цена за единицу", "единичная расценка", "материалы цена", "работа цена"],
  total: ["сумма", "стоимость", "итого", "всего", "стоимость всего", "общая стоимость", "сметная стоимость", "сумма всего"],
