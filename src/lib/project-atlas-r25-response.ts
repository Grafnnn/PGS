...
type AtlasVersion = "v5" | "v8" | "v8-ui1" | "v8-ui2" | "v8-ui3";
type Asset = { source?: "v8" | "v8-ui1" | "v8-ui2"; pack: string; offset: number; storedBytes: number; bytes: number; compressed: boolean; sha256: string; contentType: string };
...
export async function projectAtlasR25Response(request: Request, segments: string[], version: AtlasVersion = "v5") {
  ...
  try {
    ...
    const inherited = (version === "v8-ui1" || version === "v8-ui2" || version === "v8-ui3")
      && (asset.source === "v8" || ((version === "v8-ui2" || version === "v8-ui3") && asset.source === "v8-ui1")
        || (version === "v8-ui3" && asset.source === "v8-ui2"));
