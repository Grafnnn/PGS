...
async function main() {
  ...
  if (seedDemoProject) {
    ...
    for (const item of demoState.dailyReports) {
      const { crewMembers, workOutputs, workScopes, evidenceDocuments: _evidenceDocuments, ...reportData } = item;
      await prisma.dailyReport.upsert({
        ...
        create: {
          ...
          workOutputs: workOutputs as unknown as Prisma.InputJsonValue | undefined,
          workScopes: workScopes as unknown as Prisma.InputJsonValue | undefined,
          organizationId: org.id,
